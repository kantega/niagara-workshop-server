...
public class SkinnyMux<A> implements JsonEncoder<A> {
    ...
    public static <A> org.kantega.kson.skinny.SkinnyMux<A> muxer() {
        return new org.kantega.kson.skinny.SkinnyMux<>(a -> Option.none());
    }

    public <T extends A> org.kantega.kson.skinny.SkinnyMux<A> add(Class<T> c, String name, JsonEncoder<T> encoder) {
        ...
        return new org.kantega.kson.skinny.SkinnyMux<>(a -> encoders.f(a).orElse(f.f(a)));
    }
