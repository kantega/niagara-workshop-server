...
import org.kantega.kson.parser.ParseFailure;
...
import static org.kantega.kson.json.JsonValues.jNum;
...
public class JsonParser {
   ...
   */
    ...
    public static JsonResult<JsonValue> parse(String string) {
        try {
            return JsonResult.success(new org.kantega.kson.parser.JsonParser(string).parse());
