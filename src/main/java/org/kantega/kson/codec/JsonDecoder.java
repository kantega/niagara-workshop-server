...
public interface JsonDecoder<A> extends F<JsonValue, JsonResult<A>> {
     ...
     */
    default <B> org.kantega.kson.codec.JsonDecoder<B> map(F<A, B> f) {
     ...
     */
    default <B> org.kantega.kson.codec.JsonDecoder<B> bind(F<A, org.kantega.kson.codec.JsonDecoder<B>> f) {
     ...
     */
    default org.kantega.kson.codec.JsonDecoder<A> ensure(F<A, Boolean> pred) {
     ...
     */
    default org.kantega.kson.codec.JsonDecoder<A> ensure(F<A, Boolean> pred, String msg) {
     ...
     * @return A new decoder that fails if the predicate does not hold.
     */
    default org.kantega.kson.codec.JsonDecoder<A> ensure(F<A, Boolean> pred, F<A, String> msg) {
        return v ->
