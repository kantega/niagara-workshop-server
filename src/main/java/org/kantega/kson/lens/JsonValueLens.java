...
public class JsonValueLens extends JsonLens<JsonValue, JsonValue> {
  ...
  public <B> org.kantega.kson.lens.JsonValueLens then(org.kantega.kson.lens.JsonValueLens other) {
    return new org.kantega.kson.lens.JsonValueLens(
        s -> get(s).bind(other::get),
        (b, s) -> mod(s, a -> other.set(a, b))
    );
  }

  public org.kantega.kson.lens.JsonValueLens select(String fieldName) {
